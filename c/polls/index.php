...
?>
	...
	{
		if(!$poll['voted'])
			echo "<li><a href=\"showpoll/?pid=".$poll['id']."\" >".$poll['title']."</a>".(intval($poll['closed'])==1?"<img title=\"Umfrage geschlossen: Es kann nicht mehr abgestimmt werden\" style=\"width: 20px; height: 20px; vertical-align: middle;\" src=\"".$rootfolder."images/lock.png\">":"")."</li>";
	}
	?>	
	</ul>
