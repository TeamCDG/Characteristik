...
?>
	...
	<?php 
		...
		foreach($users as $user)
		{
			...
			if(($colc +1) % $colcount == 0)
				echo "<td class=\"b\"><a href=\"".$rootfolder."c/showuser/?uid=".$user->id."\">".$user->prename." ".$user->name."</a></td>";
			else
				echo "<td class=\"br\"><a href=\"".$rootfolder."c/showuser/?uid=".$user->id."\">".$user->prename." ".$user->name."</a></td>";
